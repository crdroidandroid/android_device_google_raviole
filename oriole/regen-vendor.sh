...
VENDOR_SKIP_FILES=(
    ...
    "bin/hw/android.hardware.graphics.allocator@4.0-service"
    ...
    "bin/hw/android.hardware.usb@1.3-service.gs101"
    ...
    "etc/init/android.hardware.graphics.allocator@4.0-service.rc"
    ...
    "etc/init/android.hardware.usb@1.3-service.gs101.rc"
    ...
    "etc/vintf/manifest/android.hardware.usb@1.3-service.gs101.xml"
    ...
    "lib/com.google.hardware.pixel.display-V3-ndk_platform.so"
    "lib/hw/android.hardware.audio.effect@7.0-impl.so"
    "lib/hw/android.hardware.audio@7.0-impl.so"
    "lib/hw/android.hardware.bluetooth.audio@2.1-impl.so"
    "lib/hw/android.hardware.graphics.allocator@4.0-impl.so"
    "lib/hw/android.hardware.graphics.mapper@4.0-impl.so"
    "lib/hw/android.hardware.health@2.0-impl-2.1-gs101.so"
    ...
    "lib64/com.google.hardware.pixel.display-V3-ndk_platform.so"
    "lib64/hw/android.hardware.audio.effect@7.0-impl.so"
    "lib64/hw/android.hardware.audio@7.0-impl.so"
    "lib64/hw/android.hardware.bluetooth.audio@2.1-impl.so"
    "lib64/hw/android.hardware.gnss@2.1-impl-google.so"
    "lib64/hw/android.hardware.graphics.allocator@4.0-impl.so"
    "lib64/hw/android.hardware.graphics.mapper@4.0-impl.so"
    "lib64/hw/android.hardware.health@2.0-impl-2.1-gs101.so"
    ...
    "lib64/pixel_stateresidency_provider_aidl_interface-ndk_platform.so"
    ...
    "lib64/android.hardware.biometrics.fingerprint-V1-ndk_platform.so"
    ...
    "lib64/android.hardware.neuralnetworks-V1-ndk_platform.so"
